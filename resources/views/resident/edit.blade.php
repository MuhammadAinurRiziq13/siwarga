                ...
                <form method="POST" action="{{ url('/resident/' . $resident->NIK) }}" class="form-horizontal">
                    ...
                    <div class="form-group row mx-auto">
                        <div class="col-6">
                            ...
                            @else
                                <select class="form-control" id="status_keluarga" name="status_keluarga" required>
                                    <option value="anak" @if ($resident->status_keluarga == 'anak') selected @endif> Anak </option>
                                    <option value="istri" @if ($resident->status_keluarga == 'istri') selected @endif> Istri </option>
                                    <option value="kepala keluarga" @if ($resident->status_keluarga == 'kepala keluarga') selected @endif> Kepala
                                        Keluarga </option>
                                </select>
                            @endif
